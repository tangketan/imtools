...
if(EXISTS "${OpenCV_DIR}")
  ...
  if(${OpenCV_VERSION} VERSION_GREATER 2.1.0)
    ...
    foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
		if(WIN32)
			find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" "opencv_${__CVLIB}${CVLIB_SUFFIX}" PATHS "${OpenCV_DIR}/x86/vc12/lib" NO_DEFAULT_PATH)
			find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}" "opencv_${__CVLIB}${CVLIB_SUFFIX}" "opencv_${__CVLIB}" "${__CVLIB}" PATHS "${OpenCV_DIR}/x86/vc12/lib" NO_DEFAULT_PATH)
		else(WIN32)
			find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" "opencv_${__CVLIB}${CVLIB_SUFFIX}" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
